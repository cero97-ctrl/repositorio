...
El objetivo es determinar el circuito equivalente de Thévenin y de Norton entre los terminales del nodo "A" y tierra (GND). El circuito tiene dos nodos principales, "A" y "B".
