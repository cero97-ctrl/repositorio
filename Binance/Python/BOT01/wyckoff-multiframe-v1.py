# wyckoff-multiframe-v1.py — (Modo profesional Wyckoff multi-timeframe + Gestión de riesgo básica)
# VERSIÓN MEJORADA con detección de fase HTF basada en volumen.
...
if __name__ == "__main__":
    ...
    startup_message = (
        f"🚀 *Bot Wyckoff Multi\\-Timeframe v1 Iniciado* 🚀\n\n"
