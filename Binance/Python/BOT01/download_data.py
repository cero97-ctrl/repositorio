...
def download_historical_data(symbol, interval, limit, output_file):
    ...
    """
    logging.info(
        f"Iniciando descarga de hasta {limit} velas para {symbol} en intervalo {interval}..."
    )
    ...
    while klines_to_fetch > 0:
        ...
        try:
            ...
            if not data:
                logging.info(
                    "No se recibieron más datos de la API. Finalizando descarga."
                )
                break
            ...
            end_time = (
                data[0][0] - 1
            )  # Timestamp de la primera vela para la siguiente petición
    ...
    try:
        ...
        logging.info(
            f"✅ Datos guardados exitosamente en '{os.path.abspath(output_file)}'"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Número de velas a descargar. Puede ser mayor a 1000.",
    )
    parser.add_argument(
        "--output",
        type=str,
