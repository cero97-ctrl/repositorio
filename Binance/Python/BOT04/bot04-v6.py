...
def evaluate_context(df, signals):
    ...
    for i, pattern in signals:
        ...
        if pattern in {"Hammer", "Bullish Engulfing", "Morning Star", "Piercing Line", "Three White Soldiers"} and soporte and vol_alto and tendencia == "bajista":
            recomendacion = "✅ Compra"
        elif pattern in {"Shooting Star", "Bearish Engulfing", "Evening Star", "Dark Cloud Cover", "Three Black Crows"} and resistencia and vol_alto and tendencia == "alcista":
            recomendacion = "🔻 Venta"
        else:
